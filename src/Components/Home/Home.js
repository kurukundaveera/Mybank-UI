...
export class Home extends Component {
    ...
    render() {
        ...
        const txnHistory=this.props.location.state.data
        let sorted=txnHistory.reverse().slice(0,10)
        return (    
            <div>
                <h1> My Bank Dashbard</h1>
                <div className="btn-group tab">
                    <button type="button" id="txnhistory" class="btn btn-primary" onClick={(e)=>{this.handleSubmit(e,1)}}>Txn History</button>
                    <button type="button" id="fundstransfer" class="btn btn-secondary" onClick={(e)=>{this.handleSubmit(e,2)}}>Funds Transfer</button>
                </div>
                <br></br><br></br>
